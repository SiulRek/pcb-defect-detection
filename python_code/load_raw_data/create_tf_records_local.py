...
from python_code.utils.search_files_with_name import search_files_with_name
...
if __name__ == '__main__':
    ...
    tf_records_paths = []
    tf_records_paths.append(os.path.join(ROOT_DIR, r"data\tensorflow_records\pcb_defects_kaggle.tfrecord"))
    tf_records_paths.append(os.path.join(ROOT_DIR, r"data\tensorflow_records\deep_pcb_train.tfrecord"))
    tf_records_paths.append(os.path.join(ROOT_DIR, r"data\tensorflow_records\deep_pcb_test.tfrecord"))
    ...
    if successfully_created:
        ...
        SimplePopupHandler().display_popup_message('Something went wrong while creating Tensorflow Records.')