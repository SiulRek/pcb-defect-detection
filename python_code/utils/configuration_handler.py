...
class ConfigurationHandler:
    ...
    and an optional `_init_params_datatypes` class attribute for guided deserialization with type conversion.
    ...
    def _create_class_instance(self, class_name, json_data, additional_init_params=None):
        ...
        if hasattr(mapped_class, '_init_params_datatypes'):

            if type(mapped_class._init_params_datatypes) is not dict:
