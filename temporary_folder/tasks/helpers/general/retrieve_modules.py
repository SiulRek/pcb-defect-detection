...
def retrieve_modules(json_file):
    """
    Retrieves names of standard library modules and third-party modules in the current Python environment.
    Stores them in a JSON file under 'standard_library' and 'third_party' keys.

    Args:
        json_file (str): The path to the JSON file to store the modules information.
    """
