...
def generate_directory_tree(
    ...
    Args:
        ...
        max_depth (int): The maximum depth of the directory structure to display.
            Defaults to float('inf').
        include_files (bool): Whether to include files in the directory structure.
            Defaults to True.
        additional_ignore_list (list): A list of file or directory names to ignore.
            Defaults to None.
