...
def parse_tfrecord(sample_proto):
    """ Parses a serialized Example proto. It parses the image and label tensors
...
def load_tfrecord_from_file(filepath):
    ...
    parsed_dataset = parsed_dataset.prefetch(
        buffer_size=tf.data.experimental.AUTOTUNE
    )  # Allows parallel processing of multiple items.
