...
class PCBVisualizerforTF(PCBVisualizerBase):
    ...
    def plot_image_comparison(self, original_tf_dataset, processed_tf_dataset, index, title=''):
        """
...
class PCBVisualizerforCV2(PCBVisualizerBase):
    ...
    def plot_image_comparison(self, original_img_list, processed_img_list, index, title="Image Comparison"):
        """
        Plots a comparison of original and processed image.
