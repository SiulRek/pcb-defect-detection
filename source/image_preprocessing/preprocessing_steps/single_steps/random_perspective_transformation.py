...
class RandomPerspectiveTransformer(StepBase):
    ...
    def process_step(self, image_nparray):
        ...
        dst_points = np.float32([
            [random.randint(-warp_intensity, warp_intensity), random.randint(-warp_intensity, warp_intensity)],
            [width - 1 - random.randint(-warp_intensity, warp_intensity), random.randint(-warp_intensity, warp_intensity)],
            [random.randint(-warp_intensity, warp_intensity), height - 1 - random.randint(-warp_intensity, warp_intensity)],
            [width - 1 - random.randint(-warp_intensity, warp_intensity), height - 1 - random.randint(-warp_intensity, warp_intensity)]
        ])
