...
from source.image_preprocessing.preprocessing_steps import AdaptiveHistogramEqualizer, GaussianBlurrFilter, GlobalHistogramEqualizer
...
steps_data = [
    ...
    (GaussianBlurrFilter, {'kernel_size': (5,5), 'sigma': 2.0})
]
